...
import { SystemCategorization as SystemCategorizationType, InformationType, SecurityRequirement, AutoGeneratedRequirement } from '../types/srtm';
...
// NIST SP 800-60 Information Types (sample subset - would be expanded in production)
const NIST_INFORMATION_TYPES = [
  // Government Resource Planning and Management
  { category: "C.2.2.1", name: "Corrective Action", description: "Activities to eliminate the causes of existing nonconformities in order to prevent recurrence" },
  { category: "C.2.2.2", name: "Facilities, Fleet, and Equipment Management", description: "Management of government facilities, fleet, and equipment" },
  { category: "C.2.2.3", name: "Help Desk Services", description: "Centralized support for computer hardware and software issues" },
  { category: "C.2.2.4", name: "Security Management", description: "Planning and management of physical and personnel security programs" },
  { category: "C.2.2.5", name: "System Development", description: "Planning and management of system development lifecycle" },
  
  // General Government Information
  { category: "C.3.5.1", name: "Financial Management", description: "Management of government financial operations and reporting" },
  { category: "C.3.5.2", name: "Procurement", description: "Process of purchasing goods and services" },
  { category: "C.3.5.3", name: "Budget Formulation", description: "Development and preparation of budget estimates" },
  { category: "C.3.5.4", name: "Budget Execution", description: "Implementation and monitoring of approved budgets" },
  { category: "C.3.5.5", name: "Accounting", description: "Recording and reporting of financial transactions" },
  
  // Mission-Based Information
  { category: "C.4.1.1", name: "National Defense", description: "Information supporting national defense operations" },
  { category: "C.4.1.2", name: "Criminal Investigation", description: "Information supporting law enforcement investigations" },
  { category: "C.4.1.3", name: "Emergency Response", description: "Information supporting emergency and disaster response" },
  { category: "C.4.2.1", name: "Personnel Management", description: "Management of human resources and personnel information" },
  { category: "C.4.2.2", name: "Training and Education", description: "Educational programs and training management" },
];
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              const selectedType = NIST_INFORMATION_TYPES.find(t => t.category === e.target.value);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {categorization.informationTypes.map((infoType, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="text-xs text-gray-500">{infoType.category}</div>
